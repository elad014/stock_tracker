...
from constant import DOC_SERVICE_URL, INTERNAL_API_KEY, INTERNAL_API_KEY_HEADER


class DocServiceClient:
    """HTTP client for the internal doc service."""
    ...
    def __init__(
        ...
        self._base_url = (base_url or DOC_SERVICE_URL).rstrip("/")
    ...
    def _raise_from_response(self, response: httpx.Response) -> None:
        ...
        try:
            ...
            detail = response.text or "Doc Service request failed"
