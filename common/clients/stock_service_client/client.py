...
from constant import INTERNAL_API_KEY, INTERNAL_API_KEY_HEADER, STOCK_SERVICE_URL


class StockServiceClient:
    """HTTP client for the internal stock service."""
    ...
    def __init__(
        ...
        self._base_url = (base_url or STOCK_SERVICE_URL).rstrip("/")
    ...
    def _raise_from_response(self, response: httpx.Response) -> None:
        ...
        try:
            ...
            detail = response.text or "Stock Service request failed"
