...
from constant import CHAT_SERVICE_URL, INTERNAL_API_KEY, INTERNAL_API_KEY_HEADER


class ChatServiceClient:
    """HTTP client for the internal chat-service orchestrator."""
    ...
    def __init__(
        ...
        self._base_url = (base_url or CHAT_SERVICE_URL).rstrip("/")
    ...
    def _raise_from_response(self, response: httpx.Response) -> None:
        ...
        try:
            ...
            detail = response.text or "Chat Service request failed"
