...
-- Reflects live DB as of the stock_service cutover.
...
-- Owner: stock_service (read/write). news_service may JOIN this table read-only.
-- ---------------------------------------------------------------------------
...
-- Owner: news_service (read/write). stock_id references stock_quotes (owned by
-- stock_service). news_service reads stock_quotes only to join/filter by symbol.
-- ---------------------------------------------------------------------------
