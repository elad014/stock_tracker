...
API_DESCRIPTION = """
Internal Chat Service orchestrator for stock_tracker.

Gathers information only through internal HTTP clients (doc-service, news-service,
stock-service). It does not access a database. LiteLLM tool calling routes
user questions to those services and synthesizes a conversational reply.
