...
@router.post(
    "/jobs/news-update",
    tags=["Jobs"],
    summary="Trigger news update: news -> LLM summary -> DB update (all stocks)",
    description=(
        "Runs the full news service for **all** stocks, one stock at a time:\n\n"
        "1. List stocks from stock-service\n"
