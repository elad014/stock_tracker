...
from clients.stock_service_client import StockServiceClient
...
def _stock_service_client() -> StockServiceClient:
...
async def run_news_update() -> None:
    ...
    Each run:
    1. List stocks from stock-service (`stock_quotes`)
    ...
    """
    stock_service = _stock_service_client()
    ...
    for stock in stocks:
        ...
        try:
            ...
            await stock_service.update_stock_summery(
                stock_id,
                content,
